...
from resnet import Backbone_ResNet152_in3, Backbone_ResNet50_in1, Backbone_ResNet50_in3
...
class EGFNet(nn.Module):
    def __init__(self, n_classes):
        ...
        self.em2 = olm(64, 2)
        self.em3 = olm(64, 2)
        self.em4 = olm(64, n_classes)
        self.em5 = olm(64, n_classes)
        ...
        self.convedge = nn.Conv2d(1, n_classes, kernel_size=1)

        self.semantic = seman(n_classes)
